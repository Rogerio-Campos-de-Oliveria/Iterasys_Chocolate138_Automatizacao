...
public class testSelectProduct {
    ...
    public void i_filled_a_user_and_password(String user, String password) {
        driver.findElement(By.id("user_name")).sendKeys(user); // escrever o conteúdo da váriavel user
        driver.findElement(By.id("password")).sendKeys(password); // escrever o conteúdo da váriavel password
    ...
    public void show_page_s_title(String pageTitle) {
        ...
        assertEquals(driver.findElement(By.cssSelector("sapn.title")).getText(), pageTitle);
    ...
    public void i_verify_the_product_title(String procductTitle) {
        // Verifica se o titulo do produto corresponde ao informado na feature
        assertEquals(driver.findElement(By.cssSelector("div.inventory_details_name.large_size")).getText(), procductTitle);

    }
    @And("I verify the product price {string}")
    public void i_verify_the_product_price(String productPrice) {
        // Verifica se o preço do produto corresponde a informado na feature
    ...
    public void i_verify_the_quantity_is(String quantity) {
        // Verifica se a quantidade do produto corresponde a inforamrdo no carrinho
